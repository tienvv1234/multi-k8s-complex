...
kubectl set image deployments/client-deployment server=tienvv1234/multi-client:$SHA
kubectl set image deployments/worker-deployment server=tienvv1234/multi-worker:$SHA